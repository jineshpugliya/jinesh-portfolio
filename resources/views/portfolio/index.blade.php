            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="text-center lg:text-left">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <a href="#projects"
                            class="px-8 py-4 bg-gradient-to-r from-[var(--primary-color)] to-[var(--secondary-color)] text-white font-semibold rounded-full hover:shadow-lg hover:shadow-[var(--primary-color)]/50 transition-all duration-300 transform hover:scale-105">
                            <i class="fas fa-code mr-2"></i>
                            View Projects
                        </a>
                        <a href="{{ route('resume.download') }}"
                            class="px-8 py-4 border-2 border-[var(--primary-color)] text-[var(--primary-color)] font-semibold rounded-full hover:bg-[var(--primary-color)] hover:text-white transition-all duration-300 transform hover:scale-105">
                ...
                <div class="animate-on-scroll">
                    <div class="glass-effect rounded-2xl p-8">
                        ...
                        <div class="mt-8">
                            ...
                            <div class="space-y-3">
                                <div>
                                    <div class="font-semibold text-[var(--primary-color)]">Post Graduate Diploma in Data
                                        Engineering</div>
                            ...
                            <div class="glass-effect rounded-2xl p-8">
                                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-4">
                                    <div>
                                        ...
                                        <h4 class="text-xl text-[var(--primary-color)] font-semibold">{{ $job['company'] }}
                                        </h4>
                                    </div>
                                ...
                                <div class="flex flex-wrap gap-2">
                                    @foreach ($job['technologies'] as $tech)
                                        <span
                                            class="px-3 py-1 bg-gradient-to-r from-[var(--primary-color)] to-[var(--secondary-color)] text-white text-sm rounded-full">
                                            {{ $tech }}
                                        </span>
                                    @endforeach
                                </div>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                                ...
                                <div class="flex space-x-4">
                                    @if ($project->live_url)
                                        <a href="{{ $project->live_url }}" target="_blank"
                                            class="w-12 h-12 bg-[var(--primary-color)] rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform duration-300">
                                            <i class="fas fa-external-link-alt"></i>
                                        </a>
                                    @endif
                                    @if ($project->github_url)
                                        <a href="{{ $project->github_url }}" target="_blank"
                                            class="w-12 h-12 bg-gray-700 rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform duration-300">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex flex-wrap gap-2">
                                @foreach ($project->technologies as $tech)
                                    <span
                                        class="px-2 py-1 bg-[var(--primary-color)] bg-opacity-20 text-[var(--primary-color)] text-xs rounded-full border border-[var(--primary-color)]">
                                        {{ $tech }}
                                    </span>
                                @endforeach
                            </div>
                ...
                @empty
                    ...
                    <div class="project-card glass-effect rounded-2xl overflow-hidden animate-on-scroll">
                        <div class="relative overflow-hidden">
                            <img src="/placeholder.svg?height=200&width=400" alt="Data Engineering Pipeline"
                                class="w-full h-48 object-cover">
                        </div>
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-white mb-3">Data Engineering Pipeline</h3>
                            <p class="text-gray-300 mb-4">Built scalable data processing pipeline using Python, Hadoop, and
                                AWS for real-time analytics.</p>
                            <div class="flex flex-wrap gap-2">
                                <span
                                    class="px-2 py-1 bg-[var(--primary-color)] bg-opacity-20 text-[var(--primary-color)] text-xs rounded-full border border-[var(--primary-color)]">Python</span>
                                <span
                                    class="px-2 py-1 bg-[var(--primary-color)] bg-opacity-20 text-[var(--primary-color)] text-xs rounded-full border border-[var(--primary-color)]">Hadoop</span>
                                <span
                                    class="px-2 py-1 bg-[var(--primary-color)] bg-opacity-20 text-[var(--primary-color)] text-xs rounded-full border border-[var(--primary-color)]">AWS</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="project-card glass-effect rounded-2xl overflow-hidden animate-on-scroll">
                        <div class="relative overflow-hidden">
                            <img src="/placeholder.svg?height=200&width=400" alt="Laravel Web App"
                                class="w-full h-48 object-cover">
                        </div>
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-white mb-3">E-commerce Platform</h3>
                            <p class="text-gray-300 mb-4">Full-stack e-commerce solution with Laravel backend, payment
                                integration, and admin dashboard.</p>
                            <div class="flex flex-wrap gap-2">
                                <span
                                    class="px-2 py-1 bg-[var(--primary-color)] bg-opacity-20 text-[var(--primary-color)] text-xs rounded-full border border-[var(--primary-color)]">Laravel</span>
                                <span
                                    class="px-2 py-1 bg-[var(--primary-color)] bg-opacity-20 text-[var(--primary-color)] text-xs rounded-full border border-[var(--primary-color)]">PHP</span>
                                <span
                                    class="px-2 py-1 bg-[var(--primary-color)] bg-opacity-20 text-[var(--primary-color)] text-xs rounded-full border border-[var(--primary-color)]">MySQL</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="project-card glass-effect rounded-2xl overflow-hidden animate-on-scroll">
                        <div class="relative overflow-hidden">
                            <img src="/placeholder.svg?height=200&width=400" alt="API Integration"
                                class="w-full h-48 object-cover">
                        </div>
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-white mb-3">API Integration Platform</h3>
                            <p class="text-gray-300 mb-4">Integrated multiple third-party APIs for seamless data exchange
                                and automated workflows.</p>
                            <div class="flex flex-wrap gap-2">
                                <span
                                    class="px-2 py-1 bg-[var(--primary-color)] bg-opacity-20 text-[var(--primary-color)] text-xs rounded-full border border-[var(--primary-color)]">PHP</span>
                                <span
                                    class="px-2 py-1 bg-[var(--primary-color)] bg-opacity-20 text-[var(--primary-color)] text-xs rounded-full border border-[var(--primary-color)]">REST
                                    API</span>
                                <span
                                    class="px-2 py-1 bg-[var(--primary-color)] bg-opacity-20 text-[var(--primary-color)] text-xs rounded-full border border-[var(--primary-color)]">JavaScript</span>
                            </div>
                        </div>
                    </div>
                @endforelse
            ...
            <div class="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
                    ...
                    <div class="glass-effect rounded-2xl p-8">
                        ...
                        <div class="space-y-6">
                            <div class="flex items-center space-x-4">
                                <div
                                    class="w-12 h-12 bg-gradient-to-r from-[var(--primary-color)] to-[var(--secondary-color)] rounded-full flex items-center justify-center">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <div class="text-gray-300">Bikaner, Rajasthan, India</div>
                                </div>
                            </div>
                ...
                <div class="animate-on-scroll">
                    <form action="{{ route('contact.submit') }}" method="POST" class="glass-effect rounded-2xl p-8">
                        ...
                        @if (session('success'))
                            <div
                                class="mb-6 p-4 bg-green-500 bg-opacity-20 border border-green-500 rounded-lg text-green-300">
                                {{ session('success') }}
                            </div>
                        @endif
                        ...
                        <div class="space-y-6">
                            ...
                            <button type="submit"
                                class="w-full px-8 py-4 bg-gradient-to-r from-[var(--primary-color)] to-[var(--secondary-color)] text-white font-semibold rounded-full hover:shadow-lg hover:shadow-[var(--primary-color)]/50 transition-all duration-300 transform hover:scale-105">
